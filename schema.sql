CREATE TABLE PESSOA (
    ...
    EMAIL VARCHAR(320), -- 64 @ 255
    ENDERECO VARCHAR(128),
    CONSTRAINT PK_PESSOA_0 PRIMARY KEY (CPF)
    CONSTRAINT CK_PESSOA_0 CHECK(
        CPF ~ '^[0-9]{3}\.[0-9]{3}\.[0-9]{3}\-[0-9]{2}$') -- CHECAGEM DE VALIDEZ DOS DÍGITOS DEVERÁ SER FEITA EM APLICAÇÃO
);
...
CREATE TABLE FUNCIONARIO (
    ...
    CONSTRAINT FK_FUNCIONARIO_0 FOREIGN KEY (CPF)
        REFERENCES PESSOA (CPF)
        ON DELETE CASCADE,
    CONSTRAINT CK_FUNCIONARIO_0 CHECK(
        SALARIO > 0.0
    )
);
...
CREATE TABLE CONTRATO_ESPECIALISTA (
    ...
    DURACAO INTEGER NOT NULL, -- EM HORAS
    REMUNERACAO REAL) NOT NULL, -- CONSISTENCIA ENTRE TAXA_HORA E REMUNERAÇÃO DEVE SER MANTIDA EM APLICACAO
...
CREATE TABLE EVENTO (
    ...
    VALOR REAL,
    METODOPAGAMENTO VARCHAR(16), -- VALORES CONTROLADOS EM APLICACAO
    NROPESSOAS INTEGER,
...
CREATE TABLE LOCAL (
    ...
    CONSTRAINT CK_LOCAL_1 CHECK(
        CEP ~ '^[0-9]{5}\-[0-9]{3}$'), -- CHECAGEM DE VALIDEZ DOS DÍGITOS DEVERÁ SER FEITA EM APLICAÇÃO
